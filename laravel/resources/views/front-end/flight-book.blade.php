                            ...
                            <div>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <div class="pull-left">
                                            <strong>Passengers Fare (x {{ $total }} )</strong>
                                        </div>
                                        <div class="pull-right">
                                            <strong name="total_price" >IDR {{ $row->flight_price * $total }} </strong>
                                        </div>
                                    ...
                                    <li class="list-group-item list-group-item-info">
                                        ...
                                        <div class="pull-right">
                                            <strong>IDR {{$row->flight_price * $total}}</strong>
                                        </div>
                                        <div class="clearfix"></div>
                                    </li>
                                </ul>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div><big class="time"> {{ date("h:i", $d) }} </big></div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div><big class="time">{{ date("h:i", $d2) }}</big></div>
